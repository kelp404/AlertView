...
null==b.mode&&(b.mode="notification");c=this.prefix+ ++this.increment_id;"alert"===b.mode?(d=a("<div id='"+c+"' class='alert_view'><span class='av_title'>"+b.title+'</span> <span class="av_message">'+b.message+("</span><div class='av_close' onclick=\"$.av.hide('"+c+"');\">X</div></div>")),d.css({width:a("#alert_view_center").width()}),0===a("#alert_view_center").find(".alert_view").length&&d.css({opacity:0,"margin-top":"-25px"}),a("#alert_view_center").html(d),a("#"+c).animate({opacity:0.9,"margin-top":"0"},
400,"avOutExpo",0<b.expire?g(b.expire,function(){return a.av.hide(c)}):void 0)):(d=a("<div id='"+c+"' class='alert_view alert_view_notification'><div class='av_title'>"+b.title+'</div><div class="av_message">'+b.message+"</div></div>"),e=this.queue.length*this.height,this.queue.push(c),a("body").append(d),a("#"+c).css({right:-this.width,top:e}),a("#"+c).animate({right:0},400,"avOutExpo",0<b.expire?g(b.expire,function(){return a.av.hide(c)}):void 0));switch(b.template){case "error":d.addClass("alert_view_error");
